...
{
    [Tooltip("Weapons belonging to this loadout")]
    public WeaponAttributes[] slots;
}
...
public class Loadout : MonoBehaviour
{
    ...
    /// <summary>
    /// Is the actively equipped weapon busy right now?
    /// </summary>
    public bool IsActiveWeaponBusy()
    {
        if (_slots == null)
        {
            Debug.LogError("No slots have been added to this loadout. Ensure loadout was initialized.");
            return false;
        }

        return _slots[_activeSlotIndex].Busy;
    }
    ...
    public bool SetCombatBlock(bool isCombatBlocked, string tag)
    {
        ...
        if (!isCombatBlocked)
        {
            ...
            {
                Debug.LogWarning("Combat block tag not found, may already have been removed.");
                return _isCombatBlocked;
            }
        ...
        else 
        {
            ...
            if(_weaponBlockTags.Contains(tag))
            {
                ...
                Debug.LogError("Tried to add another stack of combat block with a tag already in use.");
    ...
    {
        _slots[_activeSlotIndex].OnInputActionComplete.RemoveListener(AllowWeaponSwitching);
    ...
    public void Fire()
    {
        ...
        _slots[_activeSlotIndex].OnInputActionComplete.AddListener(AllowWeaponSwitching);
    ...
    public void FireSecondary()
    {
        ...
        _slots[_activeSlotIndex].SecondaryFire();
    }
